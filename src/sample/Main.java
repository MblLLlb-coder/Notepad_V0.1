...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        bMusic.setOnAction(actionEvent -> {
            try {
                File sf = new File("E:/Загрузки/Arthas.wav");//Path to music you need(.wav is required)
        ...
        bSave.setOnAction(actionEvent -> {
            ...
            bName.setOnAction(actionEvent1 -> {
                ...
                try (FileWriter fw = new FileWriter("C:/Users/Мышь/Desktop/" + NameofNote.trim() + ".txt")) {//you can replace .npz with simple .txt
        ...
        bOpen.setOnAction(actionEvent -> {
            ...
            bName.setOnAction(actionEvent1 -> {
                ...
                try (FileReader reader = new FileReader("C:/Users/Мышь/Desktop/" + name1.trim() + ".txt")) {//you can replace .np for simple .txt
